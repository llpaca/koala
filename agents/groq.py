"""
Minimal Groq API client using raw `requests`.
Covers: chat completions and tool calling.

Groq's API is OpenAI-compatible, served at https://api.groq.com/openai/v1
(Note: Groq does not currently offer an embeddings endpoint.)
...
class GroqClient:
    ...
    def __init__(self, api_key: str | None = None):
        ...
        if not self.api_key:
            raise ValueError("Set GROQ_API_KEY env var or pass api_key explicitly.")
